                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="pt-4 border-t">
                        <button
                            type="submit"
                            disabled={submitting}
                            className="w-full inline-flex items-center justify-center rounded-md text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-8 shadow-sm"
                        >
                            {submitting ? 'Sending...' : (
