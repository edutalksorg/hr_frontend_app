...
import { Send, Users, User as UserIcon, BellRing, AlertCircle } from 'lucide-react';
...
const SendNotificationPage: React.FC = () => {
    ...
    const fetchUsers = async () => {
        try {
            ...
            // We need all users to select a recipient
            const data = await apiService.getAllUsers();
            // Filter out admins if you prefer, or keep them. Often admins want to msg other admins.
            // Keeping all.
            setUsers(data);
        } catch (error) {
        ...
        <div className="max-w-2xl mx-auto p-4 md:p-6 lg:p-8">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground mt-1">
                    Send private messages or broadcast announcements to the team.
                </p>
            </div>
